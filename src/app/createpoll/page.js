    ...
    return(
        <Layout>
            ...
            <form onSubmit={handleSubmit}>
                ...
                <input type="text" name="pollQuestion1" onChange={handlePollQuestion1}/>
                <label htmlFor="pollQuestion2">Svar alternativ 2</label>
                <input type="text" name="pollQuestion2" onChange={handlePollQuestion2}/>
                <label htmlFor="pollQuestion3">Svar alternativ 3</label>
                <input type="text" name="pollQuestion3" onChange={handlePollQuestion3}/>
